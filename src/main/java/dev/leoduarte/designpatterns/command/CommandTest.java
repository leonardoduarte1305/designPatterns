package dev.leoduarte.designpatterns.command;

import dev.leoduarte.designpatterns.command.implementations.commands.DecreaseCommand;
import dev.leoduarte.designpatterns.command.implementations.commands.IncreaseCommand;
import dev.leoduarte.designpatterns.command.implementations.commands.TurnOffCommand;
import dev.leoduarte.designpatterns.command.implementations.commands.TurnOnCommand;
import dev.leoduarte.designpatterns.command.implementations.invoker.FourButtonsController;
